...
int main(){
    ...
    std::cout << " a && b && b : " << (a && b &&c) << std::endl; //false

    //OR : Evaluates to true when anyone operands are true
    //      A single true operand will drag the entire expression to evaluating true
    ...
    std::cout << " a || c : " << (a || c) << std::endl; //true
    std::cout << " a || b || b : " << (a || b ||c) << std::endl; //true
    ...
    //Combination of logical operators with relational operators
    int d {45};
    int e {20};
    int f {11};
